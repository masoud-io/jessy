...
public abstract class DB {
	...
	public abstract int createTransaction(
			YCSBTransactionalCreateRequest createRequest);
	
	public abstract int readTransaction(
			List<YCSBTransactionalReadRequest> readList);
