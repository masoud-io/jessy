...
java -ea -Xms1000m -Xmx2000m -XX:+UseConcMarkSweepGC com.yahoo.ycsb.Client ${workloadType} -db com.yahoo.ycsb.JessyDBClient -s -threads ${nthreads} -P ${workingdir}/${workloadName} &> ${scriptdir}/${hostname}.prob 2> ${scriptdir}/${hostname}
