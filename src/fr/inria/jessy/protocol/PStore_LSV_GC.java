 ...
 *
 */
public class PStore_LSV_GC extends SER {

	private static Logger logger = Logger.getLogger(PStore_LSV_GC.class);

	public PStore_LSV_GC(JessyGroupManager m, DataStore dateStore) {
		super(m, dateStore);
	}
